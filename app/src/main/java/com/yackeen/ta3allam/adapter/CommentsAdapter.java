...
public class CommentsAdapter extends RecyclerView.Adapter<CommentsAdapter.ViewHolder>{
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindView(Comment comment, Context context){
            Picasso.with(context).load(comment.getUserPictureURL()).error(R.drawable.default_emam).into(profileImage);
    ...
    public CommentsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        ...
        View categoryView = inflater.inflate(R.layout.card_view_comment, parent, false);
