...
public class NotificationsAdapter extends RecyclerView.Adapter<NotificationsAdapter.ViewHolder>{
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            nameTextView = (TextView) itemView.findViewById(R.id.name_netofy);
            notificationDetail = (TextView) itemView.findViewById(R.id.notification_detail);
            notificationTime = (TextView) itemView.findViewById(R.id.notification_time);
            imageView = (CircleImageView) itemView.findViewById(R.id.notification_from_image);
        ...
        public void bindView(Notification notification){
            ...
            Picasso.with(mContext).load(notification.getUserPictureURL()).error(R.drawable.default_emam).into(imageView);
    ...
    public NotificationsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View notificationsView = inflater.inflate(R.layout.notification_card_view, parent, false);
